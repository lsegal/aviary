...
// typed session messages so template property access is safe for TS
type SessionMessage = { id?: string; role?: string; timestamp?: string; content?: string; media_url?: string };
