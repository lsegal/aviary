    ...
    <div class="flex h-full flex-col overflow-hidden">
      ...
      <div class="shrink-0 border-b border-gray-200 bg-white px-4 py-3 dark:border-gray-800 dark:bg-gray-900">
        <div class="flex flex-wrap items-center gap-2">
          ...
          <!-- Level filter -->
          <select
            v-model="logs.filterLevel.value"
          ...
          <div class="flex flex-wrap gap-1">
            <button
              v-for="comp in logs.allComponents.value"
              :key="comp"
      ...
      >
        ...
        <div
          v-for="entry in logs.filtered.value"
          :key="entry.seq"
        ...
        >
          ...
          <!-- Level badge -->
          <span
            class="shrink-0 w-10 text-center rounded text-xs font-semibold uppercase tracking-wide"
          ...
          <span
            ...
            :class="componentLabelClass(entry.component)"
      ...
      <!-- Error banner -->
      <div v-if="logs.error.value" class="shrink-0 border-t border-yellow-700 bg-yellow-950 px-4 py-2 text-xs text-yellow-300">
        {{ logs.error.value }}
      </div>
    </div>
  </AppLayout>
